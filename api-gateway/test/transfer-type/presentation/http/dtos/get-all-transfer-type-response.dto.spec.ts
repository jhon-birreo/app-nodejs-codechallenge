import { TransferTypeResponseDto } from '../../../../../src/features/transfer-type/presentation/http/dtos/get-all-transfer-type-response.dto';

describe('TransferTypeResponseDto (HTTP)', () => {
