import { TransferTypeProviderResponseDto } from '../../../../../src/features/transfer-type/infrastructure/providers/dtos/get-transfer-type-response.dto';

describe('TransferTypeProviderResponseDto', () => {
  it('should create an instance with correct properties', () => {
    const dto = new TransferTypeProviderResponseDto();
    dto.id = 1;
    dto.name = 'Visa';
